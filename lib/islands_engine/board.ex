defmodule IslandsEngine.Board do
	...
	# Set island on board if island does not overlap any other island on board
  ...
  # Used in position_island/3 to if island trying to be set overlaps with other islands already set
  defp overlaps_existing_island?(board, new_key, new_island) do
  	# Enumerates over islands to determine 
